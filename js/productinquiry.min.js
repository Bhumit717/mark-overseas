$(document).ready(function (e) {
    $("#productenq_form").on("submit", function (e) {
        //alert("call"); 
        e.preventDefault();
        // $("html, body").animate({
        //     scrollTop: 0
        ...
        if (name == '') {
            $("#emailMsg").html('<div class="alert alert-danger"><i class="fa fa-fw fa-exclamation-triangle"></i><strong>Full Name is required!</strong></div>');
        ...
        if (phone == "") {
            ...
            $.ajax({
                type: 'POST',
                url: './productinquiry-action.php',
                data: $("#productenq_form").serialize(),
                success: function (data) {
                    $("#overlay").html(data);
                    $("#email, #name, #message, #phone").val('');
